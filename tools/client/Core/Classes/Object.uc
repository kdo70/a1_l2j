...
// Split removed: the Interlude client's Core.Object has no Split, and UICommonAPI declares its own.
// Leaving the kit's declaration in makes ucc reject that override with 'specifiers differ from original'.

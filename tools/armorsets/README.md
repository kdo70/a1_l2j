...
`generate.ps1` gives each of the 79 armor looks of the datapack a ladder from the grade it already has up
to S — **313 sets, 1410 minted items** — and `patch_client.ps1` teaches the client those new ids.

...
| `weapons.csv` | 503 оружия, у которых есть лестница: id, имя, класс, стартовый грейд. **Исходник, правится руками**, генератор его не переписывает. |
...
- **`generate.ps1` владеет id `12000..13051`** и файлами `data/xml/items/12*.xml`, `13*.xml`.

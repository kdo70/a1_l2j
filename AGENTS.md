...
- **У оружия нет SA-копий, нет shadow-оружия, и у него тоже есть лестница грейдов.**
  ...
  **No Grade оружие не прокачивается**, всё, что выше, доходит до S: 503 оружия, 1052 копии
  (`12000..13051`) — по одной на каждый грейд выше своего, с верхом грейда по своему классу

...
- **У оружия нет SA-копий, нет shadow-оружия, и у него тоже есть лестница грейдов.**
  441 копия вида `Arcana Mace - Acumen` удалена (список — `tools/weapons/retired_sa.csv`,
  скрипт — `remove_sa.ps1`, он же чистит байлисты, иконки, мультиселлы SA и ссылки на них);
  остались 4700 и 4900, потому что их носят NPC, а **оружие NPC не трогается ни при каких
  условиях** — правило нарушалось один раз и было восстановлено `restore_weapons.ps1`.

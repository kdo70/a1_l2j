...
- **Чемпионы бывают двух видов — красные и синие.** Настройки —
  ...
  `ChampionMobsSchedule` задаёт окна вида `дни-часОт:часДо:вид`
  (`1-20:23:red`); пустое расписание — без ограничений по времени, а вид без
  своего окна не выдаётся вовсе. Проверка идёт в момент спавна.

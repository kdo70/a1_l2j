 ...
 * <br>
 * Everything the player sees is defined there : column widths and heights (&lt;layout&gt;), colors (&lt;colors&gt;) and labels (&lt;labels&gt;) - the group caption of every {@link DropType}
 * included. The behavior is server side instead, on config/mods/droplist.properties : whether the window exists at all, which skill unlocks it, how many rows a page holds, whether the spoil groups
 * are shown and whether the rates are folded into the shown chances.<br>
 * <br>
